...
def load_data(dataset, neg_prop, aligned_prop, complete_prop, is_noise):
    ...
    view0, view1, noisy_labels, real_labels, sample_labels, class_labels0, class_labels1 = \
    ...
    if neg_prop != 0:
        ...
        print('training without noisy negatives')
    ...
    return train_pairs, train_pair_labels, train_pair_real_labels, sample_labels, class_labels0, class_labels1, all_data, all_label, all_label_X, all_label_Y, class_num, divide_seed, mask
...
def get_pairs(train_X, train_Y, neg_prop, train_label):
    ...
    return view0, view1, labels, real_labels, sample_labels, class_labels0, class_labels1
...
class getDataset(Dataset):
    def __init__(self, data, labels, real_labels, sample_labels, class_labels0, class_labels1):
        self.data = data
        self.labels = labels
    ...
    def __getitem__(self, index):
        ...
        sample_labels = np.int64(self.sample_labels[index])
        class_labels0 = np.int64(self.class_labels0[index])
        class_labels1 = np.int64(self.class_labels1[index])
        return fea0, fea1, label, real_label, sample_labels, class_labels0, class_labels1
...
def loader(train_bs, neg_prop, aligned_prop, complete_prop, is_noise, dataset):
    ...
    """
    train_pairs, train_pair_labels, train_pair_real_labels, sample_labels, class_labels0, class_labels1, \
    all_data, all_label, all_label_X, all_label_Y, class_num, divide_seed, mask \
        = load_data(dataset, neg_prop, aligned_prop, complete_prop, is_noise)
    train_pair_dataset = getDataset(train_pairs, train_pair_labels, train_pair_real_labels, sample_labels, class_labels0, class_labels1)
    ...
    return train_pair_loader, all_loader, divide_seed, class_num
